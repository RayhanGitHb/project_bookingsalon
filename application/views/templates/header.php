...
<head>
<title><?= $title; ?></title>
<link rel="icon" type="image/x-icon" href="<?= base_url();?>/assets/admin/images/favicon.ico">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?= base_url('/assets/admin/images/profile/').$admin['image'];?>">
                <span class="username"><?= $admin['nama']; ?> </span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="<?= base_url('admin/profile'); ?>"><i class=" fa fa-suitcase"></i>Profile</a></li>
