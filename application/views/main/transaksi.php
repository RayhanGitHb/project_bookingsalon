...
<div class="w3layouts-main">
	<center><h1>The Mistress Booking</h1></center>
	<br>
		...
		<div class="col-lg-12">
			<table style=" border: 0.5px solid white; margin-top: 10;">
			<tr>
				<td> <br>
				<div class="col-lg-6">
					<img src="<?= base_url('/assets/main/images/bcabank.png');?>" alt="#" class="img-fluid" width="100" height="40"/>
					<input type="text" class="ggg" name="bank1" id="bank1" value="390190 288451 1214" readonly>
				</div>
				<div class="col-lg-6">
					<img src="<?= base_url('/assets/main/images/permatabank.png');?>" alt="#" class="img-fluid" width="120" height="40"/>
					<input type="text" class="ggg" name="bank2" id="bank2" value="877803 233896 6566" readonly>
				</div>
