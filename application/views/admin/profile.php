...
<section id="main-content">
	<section class="wrapper">
		<div class="container-fluid">
			<h3 class="h3 mb4 text-gray-800">Profil Saya</h3>
		</div>
		<div class="row">
  <div class="col-sm-4 col-md-3">
    <div class="thumbnail">
      <img src="<?= base_url('/assets/admin/images/profile/').$admin['image'];?>" width="200" height="150" alt="...">
      <div class="caption">
        <h3><?= $admin['nama']; ?></h3>
        <p><?= $admin['email']; ?></p><br>
        <p><a href="#" class="btn btn-primary" role="button">Ganti Profil</a></p>
      </div>
    </div>
  </div>
</div>
